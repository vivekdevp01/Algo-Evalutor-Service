...
createBullBoard({
  queues: [new BullAdapter(sampleQueue), new BullAdapter(someOtherQueue), new BullMQAdapter(queueMQ)],
...
console.log(`all queues are stored in localhost:${serverConfig.PORT}/admin/queues`);
